...
// Source Path: untitled/nfp_add_single
// Hierarchy Level: 1
// 
...
module adder
  ...
  wire [31:0] nfp_out_pack;  // ufix32  // Split 32 bit word into FP sign, exponent, mantissa
  ...
  assign if_bitconcat_aExponent_aMantiss_out1 = (Logical_Operator1_out1 == 1'b0 ? BE : AE);
  ...
  assign if_Exponent_0_out1 = (Exponent_0_out1 == 1'b0 ? if_bitconcat_aExponent_aMantiss_out1 :C_out1);
  ...
  assign if_Exponent_0_cfType_Exp_out1 = (alphaExponent_0_cfType_Exp_out1 == 1'b0 ? alpha1_out1 : alpha0_out1);
  assign if_bitconcat_aExponent_aMantiss_1_out1 = (Logical_Operator1_out1 == 1'b0 ? BM : AM);
  ...
  assign if_bitconcat_aExponent_aMantiss_2_out1 = (Logical_Operator1_out1 == 1'b0 ? BS :AS);
  assign if_bitconcat_aExponent_aMantiss_5_out1 = (Logical_Operator1_out1 == 1'b0 ? AS :BS);
  assign bitxor_out1 = if_bitconcat_aExponent_aMantiss_2_out1 ^ if_bitconcat_aExponent_aMantiss_5_out1;
  assign if_bitconcat_aExponent_aMantiss_3_out1 = (Logical_Operator1_out1 == 1'b0 ? AE :BE);
  ...
  assign if_Exponent_0_cfType_Exp_out1_1 = (alphaExponent_0_cfType_Exp_out1_1 == 1'b0 ? alpha1_out1_1 :alpha0_out1_1);
  assign if_bitconcat_aExponent_aMantiss_4_out1 = (Logical_Operator1_out1 == 1'b0 ? AM :BM);
  ...
  assign if_opp_Sign_out1 = (bitxor_out1 == 1'b0 ? Data_Type_Conversion_out1_1 :alphamant_b_ext_out1);
  assign C_out1_1 = 8'b00000001;
  assign if_Exponent_0_out1_1 = (Exponent_0_out1_1 == 1'b0 ? if_bitconcat_aExponent_aMantiss_3_out1 :C_out1_1);
  ...
  assign if_opp_Sign_1_out1 = (Compare_To_Zero_out1 == 1'b0 ? Constant_out1 :Bit_Slice_out1);
  ...
  assign nfp_out_pack = {if_Exponent_0_Mantissa_out1, if_aExponent_cfType_Exponent_out1, if_aExponent_cfType_Exponent_1_out1};
